...
*/
    ...
    private class Go implements Runnable{
    	...
    	public void run(){
			...
			try {
				serverSocket = new ServerSocket(48765);
				...
				String target_p2p_ip = clientSocket.getRemoteSocketAddress().toString().replaceAll(":.*", "").replaceAll("/", "");
				
				if (D) {
					System.out.println("p2p_interface: " + p2p_interface);
					System.out.println("ip: " + ip);
					System.out.println("p2p_ip: " + p2p_ip);
					System.out.println("target_p2p_ip: " + target_p2p_ip);
					//sendtoUI("[Go] p2p_interface: " + p2p_interface);
				}

				if (OP.equals("3") || OP.equals("4")) { // scenario 3
    ...
    private class Client implements Runnable{
    	...
    	public void run(){		
			try {
				...
				if (D) {
					System.out.println("p2p_interface: " + p2p_interface_);
					System.out.println("ip: " + ip_);
					System.out.println("p2p_ip: " + p2p_ip_);
					System.out.println("target_p2p_ip: " + target_p2p_ip_);
					//sendtoUI("[Go] p2p_interface: " + p2p_interface);
				}
				if (OP.equals("3") || OP.equals("4")) { // scenario 3
					// for skype call, an ipip tunnel needs to e established
    ...
    @Override
	public void onConnectionInfoAvailable(final WifiP2pInfo info) {
    	System.out.println("onConnectionInfoAvailable" + n);
    	n++;
